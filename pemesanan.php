	...
	<div class="row booking-tab">
		<div class="container clear-padding">
			<ul class="nav nav-tabs">
				...
				<li class="active col-md-4 col-sm-4 col-xs-4"><a data-toggle="tab" href="#billing-info" class="text-center"><i class="fa fa-check-square"></i> <span>Pemabayaran</span></a></li>
			...
			<div class="tab-content">
				...
				<div id="billing-info" class="tab-pane fade in active">
					<div class="col-md-8 col-sm-8">
						...
						$sql = mysqli_fetch_array(mysqli_query($konek,"SELECT max(kode_kursi) as maxKode from pemesanan"));
						$newID = buatid($sql['maxKode'],1,4);

						$po = mysqli_fetch_array(mysqli_query($konek,"SELECT max(kode_pemesanan) as maxBooking from pemesanan"));
						$new = buatid($po['maxBooking'],1,4);
						?>
					<input type="text" name="kode_pemesanan" value="<?php echo $new; ?>">
									<form >
<div class="col-md-6 ol-sm-6">
										...
										<div class="col-md-6 ol-sm-6">
											...
											<input type="file" name="cvvnumber" class="form-control">
										</div>
										<div class="col-md-12">
