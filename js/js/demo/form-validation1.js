...
$(document).on('nifty.ready', function() {
    ...
    $('#demo-bv-errorcnt').bootstrapValidator({
        ...
        email: {
            ...
            validators: {
                ...
                emailAddress: {
                    message: 'Isikan email dengan benar'
                }
            }
        },
        username: {
        ...
        greaterthan: {
            validators: {
                ...
                greaterThan: {
                    ...
                    value: 50,
                    message: 'Mohon isikan yang kosong greater than 50'
                }
            }
        },
        lessthan: {
            validators: {
                ...
                lessThan: {
                    ...
                    value: 25,
                    message: 'Mohon isikan yang kosong less than 25'
                }
            }
        },
        range: {
    ...
    $('#demo-msk-phone').mask('(9999) 9999-9999');
