	...
	<div class="row booking-tab">
		<div class="container clear-padding">
			<ul class="nav nav-tabs">
				...
				<li class="active col-md-4 col-sm-4 col-xs-4"><a data-toggle="tab" href="#review-booking" class="text-center"><i class="fa fa-male"></i> <span>Review Booking</span></a></li>	
					...
					$.ajax({
						...
						success: function(data){
							if(data.hasil == true)
							{
								...
								window.location.assign('info_pembayaran.php');
							}
							else{
								swal({
									title : 'Gagal',
